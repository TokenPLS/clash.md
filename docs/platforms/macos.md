...
<section class="platform-detail-section">
  <div class="platform-detail-heading">
    <p class="section-kicker">Made for macOS</p>
...
<section class="platform-gallery-section">
  <div class="platform-detail-heading"><p class="section-kicker">A closer look</p><h2>Clear when you need it. Quiet when you don’t.</h2></div>
  <div class="platform-screenshot-rail platform-screenshot-rail--wide" aria-label="Clash for Mac screenshots">
    <img src="/screenshots/platforms/macos/gallery/en-01.webp" alt="Home on Mac" loading="lazy">
    <img src="/screenshots/platforms/macos/gallery/en-02.webp" alt="Profiles on Mac" loading="lazy">
    <img src="/screenshots/platforms/macos/gallery/en-03.webp" alt="Policy groups on Mac" loading="lazy">
    <img src="/screenshots/platforms/macos/gallery/en-04.webp" alt="Routing rules on Mac" loading="lazy">
    <img src="/screenshots/platforms/macos/gallery/en-05.webp" alt="Network utilities on Mac" loading="lazy">
  </div>
</section>
